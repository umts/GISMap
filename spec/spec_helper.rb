...
# Wait until map has finished animating and loading all data. This is
...
def visit_relative(relative_path)
  visit "#{Capybara.default_host}:#{Capybara.server_port}/#{relative_path}"
  wait_for_map
end

def click_by_title(title)
  find(:xpath, "//*[contains(@title, '#{title}')]").click
end
